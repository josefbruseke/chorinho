...
```json
{
  "ponder:dev": "bun workspace @se-2/ponder dev",
  "ponder:start": "bun workspace @se-2/ponder start",
  "ponder:codegen": "bun workspace @se-2/ponder codegen",
  "ponder:serve": "bun workspace @se-2/ponder serve",
  "ponder:lint": "bun workspace @se-2/ponder lint",
  "ponder:typecheck": "bun workspace @se-2/ponder typecheck"
}
```
...
- `bun ponder:dev` starts the dev server with hot reload. GraphiQL explorer available at `http://localhost:42069` for testing queries interactively.
