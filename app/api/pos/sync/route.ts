 ...
 *
 * Manda tudo num lote só porque o que é caro num tablet de balcão é a viagem:
 * oito vendas em oito requisições, num wifi que cai, é a fila esvaziando pela
 * metade. O veredito volta venda a venda para o PDV poder remover da fila só o
 * que de fato entrou — apagar a fila inteira porque "a requisição deu 200" é
 * como se perdem vendas de verdade.
 */
