 ...
 *
 * No lugar do "Connect Wallet" que o boilerplate trazia. Aqui ninguém conecta
 * carteira: a conta é e-mail ou Google, e a carteira nasce junto, invisível.
 * Deixar um botão de conectar carteira na tela do lojista é convidar uma
 * pergunta que o produto inteiro foi desenhado para não precisar responder.
 */
