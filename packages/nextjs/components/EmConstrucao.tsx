...
export const EmConstrucao = ({
  ...
  <div className="w-full max-w-md mx-auto px-5 py-16 flex flex-col items-center text-center gap-4">
    ...
    <span className="text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-base-300/60 text-base-content/60">
      Chega em {etapa}
    </span>

    {voltarPara && (
      <Link href={voltarPara} className="btn btn-ghost btn-sm rounded-xl mt-2">
        {voltarLabel ?? "Voltar"}
      </Link>
    )}
  </div>
